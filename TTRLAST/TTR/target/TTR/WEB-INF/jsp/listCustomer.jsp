        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active"><i class="fa fa-table"></i> 查看客户信息</li>
                </ol>
            </div>
        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped tablesorter" >
                        ...
                        <tr>
                            ...
                            <th>单位 <i class="fa fa-sort"></i></th>
                            <th>性别 <i class="fa fa-sort"></i></th>
                            <th>年龄 <i class="fa fa-sort"></i></th>
                            <th>身份证号 <i class="fa fa-sort"></i></th>
                            <th>操作 <i class="fa fa-sort"></i></th>
                        </tr>
                        </thead>
                        <tbody>
                        <c:forEach items="${cs}" var="c2" varStatus="st">
                            <tr>
                                <td>${c2.cid}</td>
                                <td>${c2.customer_name}</td>
                                <td>${c2.customer_dep}</td>
                                <td>${c2.customer_sex}</td>
                                <td>${c2.customer_age}</td>
                                <td>${c2.customer_code}</td>
                                <td>
                                    <span><a href="/editCustomer?cid=${c2.cid}">修改</a></span>
                                    <span><a href="/deleteCustomer?cid=${c2.cid}">删除</a></span>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>

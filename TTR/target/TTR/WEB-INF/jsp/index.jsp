        ...
        <ul>
            ...
            <div class="tp-static-layers">
                <div class="tp-caption tp-static-layer"
                     ...
                     data-endslide="5"
                     style="z-index: 5;">
                    <h1><span class="t_white">阿三售楼处<br>总有一款适合你</span></h1>
                </div>
                <div class="tp-caption tp-static-layer"
                     id="slide-37-layer-2"
                     data-x="['left','left','left','left']" data-hoffset="['50','50','50','50']"
            ...
            <div class="col-md-8 col-sm-8 col-xs-8 bottom15">
                <div class="single-query-slider">
                    <div class="clearfix top20">
                        <label class="pull-left">价格范围:</label>
...
<section id="property" class="padding bg_gallery">
    <div class="container">
            ...
            <c:forEach items="${hs}" var="c1" varStatus="st">
                <div class="cbp-item latest sale">
                    <div class="property_item">
                        <div class="image">
                            <a href="/listdetail?hid=${c1.id}"><img src="images/listing1.jpg" alt="latest property" class="img-responsive"></a>
                            <div class="price clearfix">
                                <span class="tag pull-right">¥<span>${c1.house_price}</span> /m²</span>
                            </div>
                            <span class="tag_t">${c1.house_new}</span>
                        ...
                        <div class="proerty_content">
                            ...
                            <div class="property_meta transparent">
                                ...
                                <span><i class="icon-bed"></i>${c1.house_type}</span>
                                <span><i class="icon-safety-shower"></i>${c1.house_decoration}</span>
                            </div>
                            <br>
        ...
        <div class="col-sm-12 text-center top20">
            <a href="listing.jsp" class="btn-dark border_radius uppercase margin40">更多详情</a>
        </div>
    </div>
</section>
<!-- Gallery End -->

...
<div class="tp_overlay">
    ...
    <form class="callus top30 clearfix centered" method="post" action="/showHouse">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="single-query bottom15">
                    <input type="text" class="keyword-input" placeholder="最大面积（平方米）" name="cid" value="${cid}" >
                </div>
            </div>
        </div>
        <div class="row">
...
<section id="property" class="padding bg_gallery">
    <div class="container">
        ...
        <div id="property-gallery" class="cbp listing1">
            ...
            <c:forEach items="${hs1}" var="c1" varStatus="st">
                <div class="cbp-item latest sale">
                    <div class="property_item">
                        <div class="image">
                            <a href="/listdetail?hid=${c1.id}"> <img src="${basePath}${c1.house_img}" alt="latest property" class="img-responsive"></a>
